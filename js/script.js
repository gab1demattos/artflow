document.addEventListener("DOMContentLoaded", function () {
	...
	const categoryModalOverlay = document.getElementById(
	...
	const newServiceModalOverlay = document.getElementById(
	...
	if (
		...
		openSubcatBtn.addEventListener("click", function () {
			if (!currentCategoryId || !subcategoriesByCategory[currentCategoryId])
				return;
	...
	if (subcategoryForm) {
		subcategoryForm.addEventListener("submit", function (e) {
			...
			if (form) {
				...
				Array.from(
					form.querySelectorAll('input[type="hidden"][name="subcategories[]"]')
